...
import DefinedDataFeed from "../../src/components/TradeChart/datafeed";
...
export interface ChartingLibraryWidgetConstructor {
	...
	new(options: {
        ...
        datafeed: DefinedDataFeed;
        custom_css_url: string;
        overrides: { "paneProperties.backgroundType": string; "paneProperties.background": string };
